...
from match_net.match_net import MatchNet, Misreporter
...
misreporter = Misreporter(N_HOS, N_TYP)
# make misreporter here
# should have parameters n_hos, n_typ
# put in inputs of size [..., n_hos, n_typ]; flatten them, pass through network, then view back.
