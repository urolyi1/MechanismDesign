...
batches = mn.create_train_sample(report_gen, args.nbatch, batch_size=args.batchsize)
test_batches = mn.create_train_sample(report_gen, 2, batch_size=10)

'''
test_batches = torch`.tensor([
    [
        [[10.0,10.0,0.0,0.0],
         [0.0,0.0,10.0,10.0]],
        [[3.0,3.0,0.0,0.0],
...
ashlagi_experiment.run_experiment(batches, test_batches, save=SAVE, verbose=True)